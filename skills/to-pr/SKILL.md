---
name: to-pr
description: Open a pull request or rewrite its description, with a one-sentence why, reviewer notes, and a visual change outline. Use whenever a pull request is opened or its description changes.
---
